    ...
    >
      <div className="mb-4 flex items-center justify-between gap-4">
        <div className="flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.18em] text-[var(--muted)]">
          <FaMagnifyingGlass className="h-3.5 w-3.5 text-[var(--accent)]" />
      ...
      <div className="grid gap-3 sm:grid-cols-[1fr_auto_1fr] sm:items-stretch">
        <div className="rounded-md border border-[rgba(37,99,235,0.14)] bg-white p-4">
          <div className="mb-3 flex items-center gap-2 text-sm font-semibold text-[var(--foreground)]">
            <span className="flex h-8 w-8 items-center justify-center rounded-full bg-[rgba(37,99,235,0.1)] text-[var(--accent)]">
          ...
          <div className="flex flex-wrap gap-2">
            {intentWords.map((word) => (
              <span
                key={word}
                className="intro-mismatch-token rounded-full bg-[rgba(37,99,235,0.1)] px-3 py-1.5 text-sm font-semibold text-[var(--accent)]"
              >
                {word}
              </span>
            ))}
        ...
        <div className="hidden items-center justify-center px-1 sm:flex">
          <div className="intro-mismatch-arrow flex h-10 w-10 items-center justify-center rounded-full border border-[var(--border)] bg-white text-[var(--muted)]">
      ...
      <div className="mt-4 grid gap-3 rounded-md border border-[rgba(41,37,36,0.08)] bg-[rgba(249,247,243,0.76)] p-3 sm:grid-cols-[auto_1fr] sm:items-center">
        <div className="flex items-center gap-2 text-[12px] font-bold uppercase tracking-[0.14em] text-[var(--muted)]">
          <FaShoePrints className="h-4 w-4 text-[var(--accent)]" />
          Search&apos;s job
        </div>
